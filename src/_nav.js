...
const _nav = [
  ...
  },
  {
    ...
    icon: <CIcon icon={icon.cilSchool} customClassName="nav-icon" />,
  },
  {
    component: CNavItem,
    name: 'Tunggakan Harian',
    to: '/references/Arrears',
    icon: <CIcon icon={icon.cilBorderAll} customClassName="nav-icon" />,
  },
  {
    component: CNavItem,
    name: 'Kolekbilitas',
    to: '/references/kolekbilitas',
    icon: <CIcon icon={icon.cilBellExclamation} customClassName="nav-icon" />,
  },
  {
    component: CNavItem,
  ...
  //   name: 'Colors',
  //   to: '/theme/colors',
  //   icon: <CIcon icon={icon.cilDrop} customClassName="nav-icon" />,
  // },
  // {
  //   component: CNavItem,
  //   name: 'Typography',
  //   to: '/theme/typography',
  //   icon: <CIcon icon={icon.cilPencil} customClassName="nav-icon" />,
  // },
  // {
  //   component: CNavTitle,
  //   name: 'Components',
  ...
  //   name: 'Base',
  //   to: '/base',
  //   icon: <CIcon icon={icon.cilPuzzle} customClassName="nav-icon" />,
  //   items: [
  //     {
  //       component: CNavItem,
  //       name: 'Accordion',
  ...
  //   component: CNavGroup,
  //   name: 'Notifications',
  //   icon: <CIcon icon={icon.cilBell} customClassName="nav-icon" />,
  //   items: [
  //     {
  //       component: CNavItem,
  //       name: 'Alerts',
  ...
  //   icon: <CIcon icon={icon.cilDescription} customClassName="nav-icon" />,
  // },
]
